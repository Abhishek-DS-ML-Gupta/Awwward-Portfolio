    ...
    <div className="relative flex flex-col items-center justify-center">
      <div
        ...
        style={{
          ...
          '--duration': '2s',
          '--logo-color': '#555555',
          '--background': 'linear-gradient(0deg, rgba(200, 200, 200, 0.2) 0%, rgba(220, 220, 220, 0.2) 100%)',
          height: 'var(--size)',
          aspectRatio: '1',
          position: 'relative',
        }}
        ...
        {[...Array(4)].map((_, i) => (
          <div
            ...
            style={{
              ...
              background: 'rgba(200, 200, 200, 0.15)',
              borderRadius: '50%',
              borderTop: `1px solid rgba(150, 150, 150, ${1 - (i + 1) * 0.2})`,
              boxShadow: 'rgba(0, 0, 0, 0.1) 0px 10px 10px 0px',
              backdropFilter: 'blur(5px)',
              WebkitBackdropFilter: 'blur(5px)',
              animation: 'ripple var(--duration) infinite ease-in-out',
      ...
      <style jsx>{`
        @keyframes ripple {
          ...
          50% {
            transform: scale(1.3);
            box-shadow: rgba(0, 0, 0, 0.15) 0px 30px 20px 0px;
          }
          100% {
            transform: scale(1);
            box-shadow: rgba(0, 0, 0, 0.1) 0px 10px 10px 0px;
...
const BubbleLoading = () => (
  <div className="fixed inset-0 z-[999] flex items-center justify-center bg-[#f8f8f2] text-[#333333] transition-opacity duration-700">
    <RippleLoader />
  </div>
);
